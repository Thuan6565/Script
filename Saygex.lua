...
local Tabs = {
    Framming = Window:AddTab({ Title = "Main", Icon = "house" }),
}
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=95051975012611";
...
local slc = Tabs.Framming:AddDropdown("DropdownSelectWeapon", {
    Title = "Select weapon",
    Description = "",
    Values = {
        "Melee",
...
local frm = Tabs.Framming:AddToggle("ToggleLevel", {
    Title = "Auto Farm Level",
    Description = "",
    Default = false
});

frm:OnChanged(function(v237)
    _G.AutoLevel = v237;
    if (v237 == false) then
        wait();
        Tween(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame);
