...
local Tabs = {
      Framming = Window:AddTab({ Title = "Framing", Icon = "house" }),

      FR = Window:AddTab({ Title = "Fruit / Raid", Icon = "apple" }),
    
      Visual = Window:AddTab({ Title = "Visual ESP", Icon = "eye" }),
      
      Teleport = Window:AddTab({ Title = "Teleport", Icon = "omega" }),

      Event = Window:AddTab({ Title = "Event", Icon = "calendars" }),
    
      Race = Window:AddTab({ Title = "Race", Icon = "calendars" }),

      PlayerTab = Window:AddTab({ Title = "Player", Icon = "calendars" }),

      Stats = Window:AddTab({ Title = "Stats", Icon = "calendars" }),

      SS = Window:AddTab({ Title = "Status / server", Icon = "calendars" }),

      Misc = Window:AddTab({ Title = "Misc", Icon = "calendars" }),
}
...
local Toggle = Tabs.Framming:AddToggle("MyToggle", 
{
    Title = "Fram Level", 
    Description = "",
    Default = false
